...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "ol,\nul {\n  margin-top: 0;\n  margin-bottom: 0;\n  padding-left: 0;\n  font-size: 14px;\n  list-style: none; }\n\n.list {\n  background-color: #fff;\n  margin-left: -10px;\n  margin-right: -10px; }\n  .list .li {\n    border-bottom: 1px solid #ccd0d7;\n    line-height: 2.6;\n    padding-left: 10px;\n    padding-right: 10px;\n    position: relative; }\n    .list .li:last-child {\n      border-bottom: 0; }\n  .list .ico {\n    padding-left: 3em;\n    -webkit-background-size: 1em 1em;\n    background-size: 1em;\n    background-position: 1em center;\n    background-repeat: no-repeat; }\n    .list .ico:before {\n      content: '';\n      position: absolute;\n      width: 12px;\n      height: 12px;\n      display: block;\n      border-radius: 50%;\n      left: 1em;\n      top: 50%;\n      margin-top: -7px; }\n  .list .success:before {\n    background-color: #00bb9c; }\n  .list .warning:before {\n    background-color: #fdbc40; }\n  .list .error:before {\n    background-color: #c84c44; }\n  .list .info:before {\n    background-color: #00a7de; }\n  .list .toggle {\n    padding-right: 6em; }\n    .list .toggle:before {\n      content: '';\n      height: 1.6em;\n      width: 3.4em;\n      position: absolute;\n      right: 1em;\n      top: 50%;\n      margin-top: -0.8em;\n      border-radius: 0.8em; }\n  .list .toggle-left:after, .list .toggle-right:after {\n    content: '';\n    width: 1.4em;\n    height: 1.4em;\n    border-radius: 50%;\n    position: absolute;\n    top: 50%;\n    margin-top: -0.7em;\n    background-color: #fff;\n    cursor: pointer;\n    -webkit-transition-duration: 0.4s;\n    transition-duration: 0.4s;\n    -webkit-transition-property: right;\n    transition-property: right;\n    -webkit-transition-timing-function: ease-in-out;\n    transition-timing-function: ease-in-out; }\n  .list .toggle-left:before, .list .toggle-right:before {\n    cursor: pointer;\n    -webkit-transition-delay: 0.4s;\n    transition-delay: 0.4s; }\n  .list .toggle-left:before {\n    background-color: #ccd0d7; }\n  .list .toggle-left:after {\n    right: 2.9em; }\n  .list .toggle-right:before {\n    background-color: #00bfef; }\n  .list .toggle-right:after {\n    right: 1.1em; }\n  .list .next {\n    padding-right: 3em; }\n    .list .next:after {\n      content: '>';\n      position: absolute;\n      right: 1em;\n      color: #99a2aa; }\n\n.list-border {\n  border-top: 1px solid #ccd0d7;\n  border-bottom: 1px solid #ccd0d7; }\n\n.list-shadow {\n  -webkit-box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.1), 0 4px 8px 0 rgba(0, 0, 0, 0.2);\n  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.1), 0 4px 8px 0 rgba(0, 0, 0, 0.2); }\n\n.list-hover .li {\n  -webkit-transition-duration: 0.4s;\n  transition-duration: 0.4s;\n  -webkit-transition-property: background-color;\n  transition-property: background-color; }\n  @media (min-width: 1025px) {\n    .list-hover .li:hover {\n      -webkit-transition-duration: 0s;\n      transition-duration: 0s;\n      background-color: #ccd0d7; } }\n  @media (max-width: 1024px) {\n    .list-hover .li:active {\n      -webkit-transition-duration: 0s;\n      transition-duration: 0s;\n      background-color: #ccd0d7; } }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./../../node_modules/postcss-loader/index.js!./hr.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./../../node_modules/postcss-loader/index.js!./hr.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./../../node_modules/postcss-loader/index.js!./tag.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./../../node_modules/postcss-loader/index.js!./tag.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".tags .tag, .tags .tag-on {\n  position: relative;\n  line-height: 14px;\n  border: 1px solid #ccd0d7;\n  margin-bottom: 1em;\n  margin-left: .5em;\n  margin-right: .5em;\n  border-radius: 14px;\n  -webkit-transition-duration: 0.4s;\n  transition-duration: 0.4s;\n  padding: 5px 15px;\n  display: inline-block; }\n\n@media (min-width: 1025px) {\n  .tags .tag:hover {\n    background-color: #00bfef;\n    border-color: #00bfef;\n    color: #fff;\n    -webkit-transition-duration: 0s;\n    transition-duration: 0s; } }\n\n@media (max-width: 1024px) {\n  .tags .tag:active {\n    background-color: #00bfef;\n    border-color: #00bfef;\n    color: #fff;\n    -webkit-transition-duration: 0s;\n    transition-duration: 0s; } }\n\n.tags .tag-on {\n  border-color: #00bfef;\n  color: #00bfef; }\n\n.tags .tag-me {\n  padding-right: 2.6em; }\n  .tags .tag-me .close {\n    position: absolute;\n    right: .8em;\n    top: 0;\n    width: 1em;\n    height: 100%;\n    display: -webkit-box;\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-align: center;\n    -webkit-align-items: center;\n    -ms-flex-align: center;\n    align-items: center;\n    -webkit-box-pack: center;\n    -webkit-justify-content: center;\n    -ms-flex-pack: center;\n    justify-content: center; }\n", ""]);
